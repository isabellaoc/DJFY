...
createNewPlaylist(id, playlistname)	{
  ...
  searchHelper(value){
    ...
    listSearchTracks = searchTracks.map((searchTracks) =>
      <li><button id= {searchTracks.uri} onClick={e => hereIsThis.addTracks(e.target.id)} style = {{width: 25, height: 25, borderWidth: 3, fontSize: 15, backgroundColor: '#FF0000'}}>-</button>{i.name}</li>
    );
    this.openModal();
  }
  ...
  .then(function(data) {
    ...
    //var i = items;
    listSearchTracks = searchTracks.map((searchTracks) =>
      <li><button id= {searchTracks.uri} onClick={e => alsoThis.addTracks(e.target.id)} style = {{width: 25, height: 25, borderWidth: 3, fontSize: 15, backgroundColor: '#FF0000'}}>-</button>{searchTracks.name}</li>
    );
          ...
          <div id="app" className="App">
            ...
            <div class="row">
              <Modal
                ...
                <button class="btn btn-sm btn-primary" onClick={this.closeModal}>close</button>
              </Modal>
